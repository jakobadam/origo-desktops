...
urlpatterns = patterns('',
    ...
    url(r'^farms/(?P<pk>\d+)/software/$', 'rds.views.farm_software', name='farm_software'),
    ...
    url(r'^farms/(?P<farm_pk>\d+)/package/(?P<farm_package_pk>\d+)/create/$', 'rds.views.farm_package_create', name='farm_package_create'),        
